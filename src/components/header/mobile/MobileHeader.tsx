  ...
  return (
    <div className='fixed z-30 bottom-0 left-0 right-0 bg-light'>
      <ul className='flex justify-between sm:w-[90%] w-[95%] mx-auto sm:py-5 py-3 border-t border-darker-black/30'>
        <li className='flex-1 flex items-center text-sm flex-col sm:text-xl text-darker-black/60 gap-1.5'>
        ...
        <li className='flex-1 flex items-center flex-col text-sm sm:text-xl text-darker-black/60 gap-1.5'>
